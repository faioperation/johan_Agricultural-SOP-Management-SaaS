...
async function main() {
  ...
  const basicPlan = await prisma.plan.upsert({
    ...
    update: {
      priceMonthly: 20,
      priceYearly: 240,
      stripeMonthlyPriceId: "price_1TWq43LI3rTiFI8G1tk8RzkN",
      stripeYearlyPriceId: "price_1TWq4OLI3rTiFI8G2Ih3Qc1C",
      employeeLimit: 10,
      trialDays: 14,
      isActive: true,
      features: [
  ...
  const standardPlan = await prisma.plan.upsert({
    ...
    update: {
      priceMonthly: 30,
      priceYearly: 360,
      stripeMonthlyPriceId: "price_1TWq5YLI3rTiFI8GvXJNBUv1",
      stripeYearlyPriceId: "price_1TWq5oLI3rTiFI8GQtkzL94j",
      employeeLimit: 25,
      trialDays: 14,
      isActive: true,
      features: [
  ...
  const professionalPlan = await prisma.plan.upsert({
    ...
    update: {
      priceMonthly: 50,
      priceYearly: 600,
      stripeMonthlyPriceId: "price_1TWq6dLI3rTiFI8GuK64juaN",
      stripeYearlyPriceId: "price_1TWq7eLI3rTiFI8G5NaFTNgt",
      employeeLimit: 35,
      trialDays: 14,
      isActive: true,
      features: [
