...
class _UserChatScreenState extends State<UserChatScreen> {
  final UserChatController _chatController = Get.find<UserChatController>();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leadingWidth: w * 0.12,
        leading: IconButton(
          icon: Icon(Icons.arrow_back_ios, size: w * 0.045, color: Colors.black),
        ...
        title: Row(
          children: [
            CircleAvatar(
              ...
              child: Icon(Icons.person, color: Colors.blue, size: w * 0.06),
            ),
      ...
      body: Column(
        children: [
          Expanded(
            child: Obx(() {
              ...
              return ListView.builder(
                padding: EdgeInsets.fromLTRB(w * 0.04, h * 0.02, w * 0.04, h * 0.01),
                reverse: true,
          ...
          /// ================= INPUT =================
          Container(
            padding: EdgeInsets.fromLTRB(w * 0.03, h * 0.01, w * 0.03, h * 0.015),
            ...
            child: Row(
              children: [
                IconButton(
                  icon: Icon(Icons.image, size: w * 0.06, color: Colors.black54),
                ...
                GestureDetector(
                  ...
                  child: CircleAvatar(
                    ...
                    child: Icon(Icons.send, size: w * 0.05, color: Colors.black),
                  ),
                ),
              ],
            ),
