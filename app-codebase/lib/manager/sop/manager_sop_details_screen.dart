...
class ManagerSopDetailsScreen extends StatefulWidget {
  final String sopId;
  final String title;
  final String? fileUrl;
  final String? originalUrl;

  const ManagerSopDetailsScreen({
    super.key,
    required this.sopId,
    required this.title,
    this.fileUrl,
  ...
  @override
  State<ManagerSopDetailsScreen> createState() =>
      _ManagerSopDetailsScreenState();
}

class _ManagerSopDetailsScreenState
    extends State<ManagerSopDetailsScreen> {
  final ManagerSopModuleController controller = Get.find<ManagerSopModuleController>();
